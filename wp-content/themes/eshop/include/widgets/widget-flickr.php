...
class zp_flickr_widget extends WP_Widget {
	...
	function __construct(  ) {
		...
		/* Widget settings. */
		$widget_ops = array(  'classname' => 'zp_flickr_widget', 'description' => __( 'A widget that displays your Flickr photos.', 'eshop' )  );
		/* Create the widget. */
		parent::__construct(  'zp_flickr_widget', __( 'Flickr Photos', 'eshop' ), $widget_ops  );
	}
	/* ---------------------------- */
	/* ------- Display Widget -------- */
	/* ---------------------------- */
	...
	function form(  $instance  ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id(  'flickrID'  ); ?>"><?php _e( 'Flickr ID:', 'eshop' ) ?> ( <a href="http://idgettr.com/">idGettr</a> )</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id(  'postcount'  ); ?>"><?php _e( 'Number of Photos:', 'eshop' ) ?></label>
		...
		<!-- Type: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id(  'type'  ); ?>"><?php _e( 'Type ( user or group ):', 'eshop' ) ?></label>
		...
		<!-- Display: Select Box -->
		<p>
			<label for="<?php echo $this->get_field_id(  'display'  ); ?>"><?php _e( 'Display ( random or latest ):', 'eshop' ) ?></label>
