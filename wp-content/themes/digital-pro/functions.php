...
add_filter( 'get_the_content_limit', 'digital_content_limit_read_more_markup', 10, 4 );
...
genesis_register_sidebar( array(
	...
	'description' => __( 'This is the 4th section on the front page.', 'digital-pro' ),
) );
...
function sp_footer_creds_filter( $creds ) {
	$creds = '[footer_copyright] &middot; <a href="http://trinitywebmedia.com">Trinity Web Media and Development</a> • Site Proudly Developed With Talent From The USA';
	return $creds;
}
genesis_register_sidebar( array(
'id' => 'page-image',
